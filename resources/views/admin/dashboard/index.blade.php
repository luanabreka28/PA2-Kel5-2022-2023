                                    ...
                                    <div class="widget-card">
                                        <div class="media align-self-center">
                                            <div class="widget-icon bg-light-danger">
                                                <svg class="fill-danger" width="98" height="98"
                                            ...
                                            <div class="media-body">
                                                <h6>Pesanan Yang Sedang Pending</h6>
                                                <h5>{{ $total_pending }}<span
                                    ...
                                    <div class="widget-card">
                                        <div class="media align-self-center">
                                            <div class="widget-icon bg-light-warning">
                                                <svg class="fill-warning" width="98" height="98"
                                                    viewBox="0 0 98 98" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                ...
                                <div class="col-sm-6">
                                    <div class="widget-card">
                                        <div class="media align-self-center">
                                            ...
                                            <div class="media-body">
                                                <h6>Pesanan Yang Selesai</h6>
                                                <h5>{{ $total_selesai }}
                                                    <span class="font-roboto font-success f-w-700">
                                                        <i class="icofont icofont-arrow-up"></i></span>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="icon-bg">
