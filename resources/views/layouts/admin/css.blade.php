<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css/vendors/font-awesome.css') }}">
<!-- ico-font-->
...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css/vendors/animate.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css/vendors/chartist.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css/vendors/owlcarousel.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css/vendors/dropzone.css') }}">
