                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="tpbanner__item mb-30">
                            <a href="#">
                                <div class="tpbanner__content" data-background="{{ asset('assets/img/banner/dek3.png') }}">
                        ...
                        <div class="tpbanner__item mb-30">
                            <a href="#">
                                <div class="tpbanner__content"
                                    data-background="{{ asset('assets/img/banner/dek2.png') }}">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="tpbanner__item mb-30">
                            <a href="#">
                                <div class="tpbanner__content" data-background="{{ asset('assets/img/banner/dek1.png') }}">
