            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tpabout__inner text-center">
                     <h5 class="tpabout__inner-sub mb-15">A Little About</h5>
                     <h3 class="tpabout__inner-title mb-35">Gaol Production</h3>
                     <p>Ingin tahu apa saja yang ada di Gaol Production? <br> Berikut informasi menganai Gaol Production</p>
               ...
               <div class="col-lg-6">
                  <div class="tpabout__inner-2 mb-30">
                     <div class="tpabout__inner-tag mb-10">
                        ...
                        <span>Welcome to Gaol Production</span>
                     </div>
                     <h3 class="tpabout__inner-title-2 mb-25">Kami Dapat Membantu <br> Persiapan/Kebutuhan Acara Anda</h3>
                     <p>Gaol Production menyediakan berbagai layanan jasa <br>
                        dalam berbagai persiapan acara yang anda rencanakan. <br> berikut cara untuk memesan layanan kami</p>
                     <div class="tpabout__inner-list">
                        <ul>
                           <li><i class="icon-check"></i> Kunjungi website Gaol Production</li>
                           <li><i class="icon-check"></i> Dapat mengunjungi langsung lokasi Gaol Production</li>
                           <li><i class="icon-check"></i> Dapat menghubungi langsung pihak Gaol Production</li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-lg-12 text-center">
                  <div class="tpsection mb-35 pt-75">
                     <h4 class="tpsection__sub-title">~ Mengapa Memilih Kami ~</h4>
                     <h4 class="tpsection__title">Apa Keunggulan Gaol Production?</h4>
                     <p>Nah berikut keunggulan Gaol Production sehingga Anda harus memilih kami</p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tpchoose__item text-center mb-30">
                     ...
                     <div class="tpchoose__content">
                        ...
                        <p>Lauk pauk yang diolah merupakan lauk pauk yang masih segar</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tpchoose__item text-center mb-30">
                     ...
                     <div class="tpchoose__content">
                        ...
                        <p>Kualitas makanan terjamin sehat dan baik</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tpchoose__item text-center mb-30">
                     ...
                     <div class="tpchoose__content">
                        ...
                        <p>design dan bahan ataupun alat yang digunakan dijamin aman dan baik</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="tpchoose__item text-center mb-30">
                     ...
                     <div class="tpchoose__content">
                        ...
                        <p>Kualitas musik yang terjamin baik dan bagus</p>
                     </div>
                  </div>
               </div>
            </div>
                ...
                <div class="tpcontact mb-30">
                    ...
                    <div class="tplocation__text">
                       ...
                       <div class="tplocation__content tplocation__content-two">
                          <ul>
                             <li>
                                <a href="#">Alamat: Jalan Sipaholon-Tarutung                                      </a>
                             </li>
            ...
            <div class="col-lg-6">
               <div class="ml-50 mt-10" >
                <div class="tpabout__inner-tag mb-10">
                 ...
                 <h3 class="tpabout__inner-title-2 mb-25">Anda Dapat  <br> Menghubungi Kami</h3>
                  <p>Berikut kami terakan kontak
                     untuk menghubungi kami. <br> </p>
                  <div class="tpabout__inner-list">
                     <ul>
                        ...
                        <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at" viewBox="0 0 16 16">
                          ...
                          </svg></i>  gaolproduction@gmail.com</li>
                     </ul>
                  </div>
               </div>
            </div>
